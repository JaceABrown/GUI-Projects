...
def clearWindow():
    for widget in top.winfo_childeren():
        widget.destroy()
...
def mainMenu():
    ...
    B1Main = Button(text = "week 1", bg = "white", command= week_1)
    B1Main.grid(column= 1, row = 2)

    B2Main = Button(text = "week 2", bg = "white", command= week_2)
    B2Main.grid(column= 1, row = 3)

    B3Main = Button(text = "week 3", bg = "white", command= week_3)
